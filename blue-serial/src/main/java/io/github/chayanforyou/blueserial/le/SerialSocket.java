...
class SerialSocket extends BluetoothGattCallback {
    ...
    private static final UUID BLUETOOTH_LE_ESP32_SERVICE = UUID.fromString("4fafc201-1fb5-459e-8fcc-c5c9c331914b");
    private static final UUID BLUETOOTH_LE_ESP32_CHAR_RW = UUID.fromString("beb5483e-36e1-4688-b7f5-ea07361b26a8");  // WNR
    ...
    private void connectCharacteristics1(BluetoothGatt gatt) {
        ...
        for (BluetoothGattService gattService : gatt.getServices()) {
            ...
            if (gattService.getUuid().equals(BLUETOOTH_LE_ESP32_SERVICE))
    ...
    private class ESP32Delegate extends DeviceDelegate {
        ...
        boolean connectCharacteristics(BluetoothGattService gattService) {
            ...
            readCharacteristic = gattService.getCharacteristic(BLUETOOTH_LE_ESP32_CHAR_RW);
            writeCharacteristic = gattService.getCharacteristic(BLUETOOTH_LE_ESP32_CHAR_RW);
            return true;
        }
    }
}
